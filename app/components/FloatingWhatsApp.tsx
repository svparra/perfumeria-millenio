...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-[#25D366] py-3 pl-3 pr-4 text-sm font-semibold text-white shadow-lg shadow-black/20 transition hover:scale-105 hover:shadow-xl sm:bottom-6 sm:right-6"
    >
